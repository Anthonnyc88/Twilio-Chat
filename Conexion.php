...
function Crear_Canal(){
    ...
    $token= "62cd3b521c0e8bd844e92c57a486fcb8";
    $twilio = new Client($sid, $token);
    $channel = $twilio->chat->v2->services("IS898de6ec424d4934afadb10306f97075")->channels->create(array("friendlyName" => $Nombre));
...
function Modificar_Canal(){
    ...
    $token= "62cd3b521c0e8bd844e92c57a486fcb8";
    $twilio = new Client($sid, $token);
    $channel = $twilio->chat->v2->services("IS898de6ec424d4934afadb10306f97075")->channels("CHXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX")->update(array("friendly_name" => "Canal X"));
    print($channel->friendlyName);
}
...
function Eliminar_Canal(){
    ...
    $token= "62cd3b521c0e8bd844e92c57a486fcb8";
    $twilio = new Client($sid, $token);
    $twilio->chat->v2->services("IS898de6ec424d4934afadb10306f97075")->channels("CHe690aaebfd8a400ea9d902464c25c298")->delete();
}