	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-12">		
				<div class="card">
					<div class="loginBox">
						<img src="images/login.png" class="img-responsive" alt="PHP MySQL logos">
						<h2>Login</h2>

						<form action="Seccion_Usuario.php" method="post">                          	
						...
						<hr><p> <a href="index.html" title="Create an account">Crear una cuenta</a>.</p>								
					</div><!-- /.loginBox -->	
				</div><!-- /.card -->
			</div><!-- /.col -->
		</div><!--/.row-->
